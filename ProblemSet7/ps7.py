...
class WordTrigger(Trigger):
    ...
    def isWordIn(self, text):
        ...
        if self.word.lower() in lower_words:
                return True
        return False
...
class PhraseTrigger(Trigger):
    ...
    def evaluate(self, story):
        return self.isPhraseIn(story.getSummary()) or \
        self.isPhraseIn(story.getTitle()) or \
        self.isPhraseIn(story.getSubject())
